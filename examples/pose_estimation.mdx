...
description: "Estimate a 6D object pose from an RGB-D image and a named 3D mesh."
---
...
## Capturing an image
Use [examples/hardware/realsense.py](https://github.com/robot-learning-co/trlc-sdk/blob/da80e6afd54bc8f263c8bf82f20a0bb6cddfffb4/examples/hardware/realsense.py) to capture an aligned RGB and Depth image of your scene. 
...
Alternatively you can also work with the example images under [examples/data/scene/](https://github.com/robot-learning-co/trlc-sdk/tree/da80e6afd54bc8f263c8bf82f20a0bb6cddfffb4/examples/data/scene).

## Estimating the 6D object pose
Follow [examples/prompt_to_object_pose.py](https://github.com/robot-learning-co/trlc-sdk/blob/c8f94e914d6af4856fce5ab4066b3b7e621bb4ac/examples/prompt_to_object_pose.ipynb)
